...
reg log_pub_count af_year_top year_af af_top top_year treated n_year is_top_aff if year < 2020

/* Run DiD */

eststo clear

reghdfe log_pub_count treated##post

reghdfe log_pub_count treated##post

reghdfe log_pub_count treated##post if is_top_aff == 0

reghdfe log_pub_count treated##post if is_top_aff == 1

reghdfe log_pub_count treated##post if is_top_aff == 0

reghdfe log_pub_count treated##post if is_top_aff == 1

reghdfe log_pub_count treated##post##is_top_aff
